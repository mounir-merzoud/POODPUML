...
Shop::Shop() : currentState(0) {
    if (!font.loadFromFile("assets/menu/Supermassive Black Hole - TTF.ttf")) {
        throw std::runtime_error("Erreur de chargement de la police");
    }

    if (!tower1Texture.loadFromFile("assets/sprites/Towers/Tower01.png") ||
        !tower2Texture.loadFromFile("assets/sprites/Towers/Tower01.png")) {
